  ...
  return (
    <div>
      <div className="flex flex-wrap container mx-auto">
        <span className="mx-auto text-3xl font-black text-blue-600">
          Submit
        </span>
      </div>
      <br />
      <div className="flex flex-wrap container mx-auto">
        <div className="mx-auto">
          <input
            type="number"
            className="border border-blue-600 text-center m-2 p-1"
            value={problemId}
      ...
      {error && (
        <div className="flex flex-wrap container mx-auto">
          <div
            className="mx-auto p-2 m-2 text-red-600"
      ...
      <div className="flex flex-wrap container mx-auto">
        <button
          className="mx-auto p-2 m-2 bg-blue-600 text-white rounded focus:bg-blue-700 focus:text-white"
          onClick={(e) => console.log("hello")}

        ...
        <form className={classes["Auth-form"]} onSubmit={formSubmitHandler}>
          <div className={classes["Auth-form-content"]}>
            ...
            {pageType === REGISTER && (
              <div className="form-group mt-4">
                ...
                {isMobile && hasNameError && (
                  <div className={classes.validError}>{nameErrorMsg}</div>
                )}
              </div>
            )}
            ...
            {/* {pageType === LOGIN && (
              ...
              >
                <FormLabel id="login-mode">
                  Choose with what you want to login
                </FormLabel>
                <RadioGroup
                  row
            ...
            {(pageType === REGISTER ||
              ...
              <div className="form-group mt-4">
                ...
                {isMobile && hasUsernameError && (
                  <div className={classes.validError}>{usernameErrorMsg}</div>
                )}
              </div>
            )}
            ...
            {(pageType === REGISTER ||
              ...
              <div className="form-group mt-3">
                ...
                {isMobile && hasEmailError && (
                  <div className={classes.validError}>{emailErrorMsg}</div>
                )}
              </div>
            )}
...
const CustomPasswordInput = ({
  ...
  return (
    <div className="form-group mt-3">
      ...
      {isMobile && hasError && (
        <div className={classes.validError}>{errorMsg}</div>
      )}
    </div>
  );
};

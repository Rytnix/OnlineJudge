...
const Question = () => {
  ...
  const submitHandler = async (event) => {
    ...
    console.log(selectedLang,question.testcase,question.name,code);
    try {
  ...
  return (
    <div>
      <div className="upper">{/* <AppBackground /> */}</div>
      <div className="lower">
        <Fragment>
          ...
          {!loading && error && (
            <div className="maindiv">
              <div className="errorTemplate">
                <div>
                  <span>Msg : </span>Wasn't able to connect to server check if
                  your are not offline or server might not be working !
                </div>
                {error && (
                  <div>
                    <span>Error : </span>
            ...
            <div>
              <div className={classes.contain}>
                <div className={classes.back}>
                  ...
                  <ButtonCustom to="/questions" color="skyblue">
                    <ArrowBackIcon
                      style={{
                        marginRight: "0.3em",
                ...
                <div className={classes.notHead}>
                  ...
                  {codeSubmittingState !== "not-initialized" && (
                    <div className={classes.body}>
                      <div
                        style={{
                          "--col": response.status === "success" ? 127 : 0,
                        }}
